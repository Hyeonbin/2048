...
ProjectDoc.h, ProjectDoc.cpp - 문서
    이 파일에는 CProjectDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CProjectDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

ProjectView.h, ProjectView.cpp - 문서 뷰
    이 파일에는 CProjectView 클래스가 들어 있습니다.
    CProjectView 개체는 CProjectDoc 개체를 보는 데 사용됩니다.
